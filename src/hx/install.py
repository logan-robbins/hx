...
EXPECTED_SKELETON_FILES = (
    ...
    "adapters/grok/start.sh",
    "adapters/grok/seam-command",
    "adapters/grok/hook.py",
    "adapters/meta/install.sh",
    "adapters/meta/start.sh",
    "adapters/meta/seam-command",
    "adapters/meta/hook.py",
    "companion/BASE.md",
